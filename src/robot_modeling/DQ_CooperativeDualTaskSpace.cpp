...
{
    return _get_robot2_ptr()->fkm(theta.tail(_get_robot2_ptr()->get_dim_configuration_space()));
}
...
{
    return _get_robot2_ptr()->pose_jacobian(theta.tail(_get_robot2_ptr()->get_dim_configuration_space()));
}
